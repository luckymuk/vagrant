...
sudo grubby --add-kernel=/boot/vmlinuz-rhcos --args="ip=10.1.1.6::10.1.1.1:255.255.255.0:master-1.openshift.aspenlab:ens5:none nameserver=10.1.1.4 rd.neednet=1 coreos.inst=yes coreos.inst.install_dev=vda coreos.inst.image_url=http://10.1.1.4:8080/installations/rhcos-4.4.3-x86_64-metal.x86_64.raw.gz coreos.inst.ignition_url=http://10.1.1.4:8080/installations/master.ign console=ttyS0" --initrd=/boot/initramfs-rhcos.img --make-default --title=rhcos
sudo reboot
